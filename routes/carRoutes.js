...
import { addCar, getAvailableCars, bookCar, getBookedCars, editCar, getCar, removeCar,myBookedCars } from '../controllers/carController.js';
...
router.get('/mybooked-cars', protect, myBookedCars);
